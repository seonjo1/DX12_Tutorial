...
// DirectX 12의 디버그 레이어 활성화
// DirectX 12 내부에서 발생하는 잘못된 API 호출이나 리소스 사용 오류를 실시간으로 검출
#if defined(_DEBUG)
    ...
    if (m_useWarpDevice)
    {
		...
		// D3D12CreateDevice(): GPU 어댑터를 지정하여 그 GPU 위에 D3D12 Device 	생성
